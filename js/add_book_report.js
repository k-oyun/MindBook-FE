    ...
    const myBookGet = async () => {
        ...
        try {
            ...
            matchingBooks.forEach((info) => {
                ...
                document.querySelector(".book-intro-info-name").innerText =
                    info.title;
        ...
        try {
            ...
            if (data.success == true) {
                document.querySelector(
                    ".book-report-right-side-bar"
                ).style.display = "flex";
                document.querySelector(".right-side-bar").style.display =
                    "none";
                ...
                document.querySelector(".creation-date").innerText =
                    data.data.createdAt;
                document.querySelector(".user-report").innerText =
                    data.data.contents;
            }
        } catch (error) {
            document.querySelector(
